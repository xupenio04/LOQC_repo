...
(input signed [7:0] a_real,
 ...
 output signed [7:0] ad
   ...
   assign mult =
    ...
    (a_real[7] == 1'b1 && b_imag[7] == 1'b1) ? ({8'b0,(~a_real +1'b1)} * {8'b0,(~b_imag +1'b1)})  :
    (a_real[7] == 1'b1 && b_imag[7] == 1'b0) ? -({8'b0,(~a_real +1'b1)} * {8'b0,b_imag}) :
    (a_real[7] == 1'b0 && b_imag[7] == 1'b1) ? -({8'b0,a_real} * {8'b0,(~b_imag +1'b1)}) :
    ({8'b0,a_real} * {8'b0,b_imag});
    
    assign ad = mult >>> SHIFT_BITS;
